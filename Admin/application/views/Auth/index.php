...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo base_url(''); ?>vendor/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            <div class="text-center">
                                <img width="270px" src="<?php echo base_url(''); ?>vendor/assets/images/bersihnesia.jpeg" alt="logo.png">
                            </div>
                            <div class="auth-box">
